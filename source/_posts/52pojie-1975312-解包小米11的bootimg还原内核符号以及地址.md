...
<blockquote>https://bbs.kanxue.com/thread-266625.htm</blockquote>
...
正在我看他各种工具实现方法，binwalk解出来的包死活解压不了的时候，突然想起来很久之前root的时候看到的一个工具<blockquote>https://github.com/affggh/magiskbootkitchen</blockquote>
...
[Asm] 纯文本查看 复制代码echo 0 > /proc/sys/kernel/kptr_restrict
cat /proc/kallsyms > kernel_symbols.txt
<blockquote>https://zhuanlan.zhihu.com/p/359234823</blockquote>
...
这个是ida pro 7.7的,如果脚本语法版本不对的话<blockquote>https://docs.hex-rays.com/archive/porting-guide-for-ida-7.4-turning-off-ida-6.x-api-backwards-compatibility-by-default</blockquote>
...
起始如果只是想看内核函数的话，之前有个大佬给的这个网址<blockquote>https://elixir.bootlin.com/linux/v6.11.5/source</blockquote>
