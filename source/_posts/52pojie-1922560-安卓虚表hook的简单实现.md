...
虚表的一个简单示例源码：[C++] 纯文本查看 复制代码class A
{
public:
...
<blockquote>https://zhuanlan.zhihu.com/p/353260837</blockquote>
...
[Asm] 纯文本查看 复制代码void VFuncHook(uintptr_t VFunc, uintptr_t hookAddr)
{
...
[C++] 纯文本查看 复制代码void hookFunc(){
 LOGD("FuncHooked");
}

[C] 纯文本查看 复制代码void *main_thread(){
