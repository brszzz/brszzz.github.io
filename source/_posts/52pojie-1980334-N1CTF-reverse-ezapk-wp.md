...
[Asm] 纯文本查看 复制代码GetStringUTFChars called from:
...
[Asm] 纯文本查看 复制代码iusp9aVAyoMI_XOR .text 000000000000106C 000000B4 00000050 R . . . . B T .
...
[Asm] 纯文本查看 复制代码_BYTE *__fastcall iusp9aVAyoMI_XOR(__int64 a1, size_t a2)
{
...
[Asm] 纯文本查看 复制代码targetString = (const char *)(*(__int64 (__fastcall **)(__int64, __int64, _QWORD))(*(_QWORD *)a1 + 0x548LL))(
 a1,
 a3,
