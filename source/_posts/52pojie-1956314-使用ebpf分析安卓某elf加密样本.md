...
[Asm] 纯文本查看 复制代码findBTFAssets btf_file=a12-5.10-arm64_min.btf
...
[Asm] 纯文本查看 复制代码xxd -r -p ‘加密文件’ >'解密文件'

然后就是mv移动到/data/local/tmp，chmod给777权限，sh执行

**0x2 base64**

解密后的文件里还有一个 echo '加密内容'| base64 -d|sh 这种的shell加密，直接把加密内容复制出来，找个base64网站解密就行，这个没啥好说的<blockquote>https://www.toolhelper.cn/EncodeDecode/Base64</blockquote>**0x3 小结**
